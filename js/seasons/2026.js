/* ============================================================
   The 2026 draft class: every drafter's teams, the league tab
   order, and each league's scoring rules. One file per draft class
   (see js/seasons/index.js) — js/data.js re-exports whichever one is
   active, so nothing else in js/ knows which class it is showing.
   Rules for the DRAFT_TEAMS people live in js/data.js, not here.
   ============================================================ */
...
export const TEAM_META = {
  ...
  peter_iu: { name:'Indiana', leagueKey:'cfb', draftTeamId:'peter', boardSub:'Hoosiers', sub:"Hoosiers", accent:'#990000', badgeStyle:'background:#990000; color:#EEEDEB;', badgeText:'IU', sportsdbId:'136897', recentLabel:'Results So Far', rundownTeamId:159, badgeUrl:'https://r2.thesportsdb.com/images/media/team/badge/pwcsog1564336028.png' },
