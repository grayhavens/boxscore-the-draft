...
export const TEAM_META = {
  ...
  houston:    { name:'Houston',     leagueKey:'mcbb', draftTeamId:'josh', boardSub:'Cougars',      sub:'Cougars',      accent:'#C8102E', badgeStyle:'background:#C8102E; color:#FFFFFF;', badgeText:'HOU', sportsdbId:null, rundownTeamId:275, espnTeamId:'248', badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/248.png' },
  purdue:     { name:'Purdue',      leagueKey:'mcbb', draftTeamId:'josh', boardSub:'Boilermakers', sub:'Boilermakers', accent:'#000000', badgeStyle:'background:#000000; color:#CEB888;', badgeText:'PUR', sportsdbId:null, rundownTeamId:321, espnTeamId:'2509', badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2509.png' },
  utahstate:  { name:'Utah State',  leagueKey:'mcbb', draftTeamId:'josh', boardSub:'Aggies',       sub:'Aggies',       accent:'#0F2439', badgeStyle:'background:#0F2439; color:#FFFFFF;', badgeText:'USU', sportsdbId:null, rundownTeamId:348, espnTeamId:'328', badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/328.png' },
