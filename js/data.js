...
export const TEAM_META = {
  liverpool:  { name:'Liverpool',   leagueKey:'epl',  draftTeamId:'josh', boardSub:'Premier League', sub:"", accent:'#C8102E', badgeStyle:'background:#C8102E; color:#F6EB61;', badgeText:'LFC',  sportsdbId:'133602', leagueId:'4328', season:'2026-2027', rundownTeamId:3446, badgeUrl:'https://r2.thesportsdb.com/images/media/team/badge/kfaher1737969724.png' },
  newcastle:  { name:'Newcastle',   leagueKey:'epl',  draftTeamId:'josh', boardSub:'Premier League', sub:"", accent:'#241F20', badgeStyle:'background:#241F20; color:#FFFFFF;', badgeText:'NUFC', sportsdbId:'134777', leagueId:'4328', season:'2026-2027', rundownTeamId:3449, badgeUrl:'https://r2.thesportsdb.com/images/media/team/badge/lhwuiz1621593302.png' },
  ...
  lightning:  { name:'Lightning',   leagueKey:'nhl',  draftTeamId:'josh', boardSub:'Tampa Bay',   sub:"Tampa Bay", accent:'#002868', badgeStyle:'background:#002868; color:#FFFFFF;', badgeText:'TBL',  sportsdbId:'134836', rundownTeamId:105, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/tb.png' },
  ...
  isaac_raptors: { name:'Raptors', leagueKey:'nba', draftTeamId:'isaac', boardSub:'NBA', sub:"", accent:'#D91244', badgeStyle:'background:#D91244; color:#FFFFFF;', badgeText:'RAP', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/tor.png' },
  drew_knicks: { name:'Knicks', leagueKey:'nba', draftTeamId:'drew', boardSub:'NBA', sub:"", accent:'#1D428A', badgeStyle:'background:#1D428A; color:#F58426;', badgeText:'KNI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/ny.png' },
  douglas_76ers: { name:'76ers', leagueKey:'nba', draftTeamId:'douglas', boardSub:'NBA', sub:"", accent:'#1D428A', badgeStyle:'background:#1D428A; color:#E01234;', badgeText:'76E', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/phi.png' },
  collin_blazers: { name:'Blazers', leagueKey:'nba', draftTeamId:'collin', boardSub:'NBA', sub:"", accent:'#E03A3E', badgeStyle:'background:#E03A3E; color:#FFFFFF;', badgeText:'BLA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/por.png' },
  erichylok_celtics: { name:'Celtics', leagueKey:'nba', draftTeamId:'erichylok', boardSub:'NBA', sub:"", accent:'#008348', badgeStyle:'background:#008348; color:#FFFFFF;', badgeText:'CEL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/bos.png' },
  patrick_spurs: { name:'Spurs', leagueKey:'nba', draftTeamId:'patrick', boardSub:'NBA', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#C4CED4;', badgeText:'SPU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/sa.png' },
  peter_pacers: { name:'Pacers', leagueKey:'nba', draftTeamId:'peter', boardSub:'NBA', sub:"", accent:'#0C2340', badgeStyle:'background:#0C2340; color:#FFD520;', badgeText:'PAC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/ind.png' },
  ericprister_hawks: { name:'Hawks', leagueKey:'nba', draftTeamId:'ericprister', boardSub:'NBA', sub:"", accent:'#C8102E', badgeStyle:'background:#C8102E; color:#FDB927;', badgeText:'HAW', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/atl.png' },
  donny_thunder: { name:'Thunder', leagueKey:'nba', draftTeamId:'donny', boardSub:'NBA', sub:"", accent:'#007AC1', badgeStyle:'background:#007AC1; color:#EF3B24;', badgeText:'THU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/okc.png' },
  isaac_bulls: { name:'Bulls', leagueKey:'nba', draftTeamId:'isaac', boardSub:'NBA', sub:"", accent:'#CE1141', badgeStyle:'background:#CE1141; color:#FFFFFF;', badgeText:'BUL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/chi.png' },
  drew_warriors: { name:'Warriors', leagueKey:'nba', draftTeamId:'drew', boardSub:'NBA', sub:"", accent:'#FDB927', badgeStyle:'background:#FDB927; color:#1D428A;', badgeText:'WAR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/gs.png' },
  douglas_rockets: { name:'Rockets', leagueKey:'nba', draftTeamId:'douglas', boardSub:'NBA', sub:"", accent:'#CE0E2D', badgeStyle:'background:#CE0E2D; color:#FFFFFF;', badgeText:'ROC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/hou.png' },
  collin_nets: { name:'Nets', leagueKey:'nba', draftTeamId:'collin', boardSub:'NBA', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#FFFFFF;', badgeText:'NET', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/bkn.png' },
  erichylok_timberwolves: { name:'Timberwolves', leagueKey:'nba', draftTeamId:'erichylok', boardSub:'NBA', sub:"", accent:'#266092', badgeStyle:'background:#266092; color:#79BC43;', badgeText:'TIM', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/min.png' },
  patrick_heat: { name:'Heat', leagueKey:'nba', draftTeamId:'patrick', boardSub:'NBA', sub:"", accent:'#98002E', badgeStyle:'background:#98002E; color:#FFFFFF;', badgeText:'HEA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/mia.png' },
  peter_jazz: { name:'Jazz', leagueKey:'nba', draftTeamId:'peter', boardSub:'NBA', sub:"", accent:'#4E008E', badgeStyle:'background:#4E008E; color:#79A3DC;', badgeText:'JAZ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/utah.png' },
  ericprister_clippers: { name:'Clippers', leagueKey:'nba', draftTeamId:'ericprister', boardSub:'NBA', sub:"", accent:'#12173F', badgeStyle:'background:#12173F; color:#C8102E;', badgeText:'CLI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/lac.png' },
  donny_pistons: { name:'Pistons', leagueKey:'nba', draftTeamId:'donny', boardSub:'NBA', sub:"", accent:'#1D428A', badgeStyle:'background:#1D428A; color:#C8102E;', badgeText:'PIS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/det.png' },
  isaac_pelicans: { name:'Pelicans', leagueKey:'nba', draftTeamId:'isaac', boardSub:'NBA', sub:"", accent:'#0A2240', badgeStyle:'background:#0A2240; color:#B4975A;', badgeText:'PEL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/no.png' },
  drew_bucks: { name:'Bucks', leagueKey:'nba', draftTeamId:'drew', boardSub:'NBA', sub:"", accent:'#00471B', badgeStyle:'background:#00471B; color:#EEE1C6;', badgeText:'BUC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/mil.png' },
  douglas_hornets: { name:'Hornets', leagueKey:'nba', draftTeamId:'douglas', boardSub:'NBA', sub:"", accent:'#008CA8', badgeStyle:'background:#008CA8; color:#1D1060;', badgeText:'HOR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/cha.png' },
  collin_kings: { name:'Kings', leagueKey:'nba', draftTeamId:'collin', boardSub:'NBA', sub:"", accent:'#5A2D81', badgeStyle:'background:#5A2D81; color:#FFFFFF;', badgeText:'KIN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/sac.png' },
  erichylok_suns: { name:'Suns', leagueKey:'nba', draftTeamId:'erichylok', boardSub:'NBA', sub:"", accent:'#29127A', badgeStyle:'background:#29127A; color:#E56020;', badgeText:'SUN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/phx.png' },
  patrick_magic: { name:'Magic', leagueKey:'nba', draftTeamId:'patrick', boardSub:'NBA', sub:"", accent:'#0150B5', badgeStyle:'background:#0150B5; color:#9CA0A3;', badgeText:'MAG', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/orl.png' },
  peter_wizards: { name:'Wizards', leagueKey:'nba', draftTeamId:'peter', boardSub:'NBA', sub:"", accent:'#E31837', badgeStyle:'background:#E31837; color:#FFFFFF;', badgeText:'WIZ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/wsh.png' },
  ericprister_grizzlies: { name:'Grizzlies', leagueKey:'nba', draftTeamId:'ericprister', boardSub:'NBA', sub:"", accent:'#5D76A9', badgeStyle:'background:#5D76A9; color:#12173F;', badgeText:'GRI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/mem.png' },
  donny_lakers: { name:'Lakers', leagueKey:'nba', draftTeamId:'donny', boardSub:'NBA', sub:"", accent:'#552583', badgeStyle:'background:#552583; color:#FDB927;', badgeText:'LAK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nba/500/lal.png' },
  isaac_ducks: { name:'Ducks', leagueKey:'nhl', draftTeamId:'isaac', boardSub:'NHL', sub:"", accent:'#FC4C02', badgeStyle:'background:#FC4C02; color:#000000;', badgeText:'DUC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/ana.png' },
  drew_stars: { name:'Stars', leagueKey:'nhl', draftTeamId:'drew', boardSub:'NHL', sub:"", accent:'#20864C', badgeStyle:'background:#20864C; color:#FFFFFF;', badgeText:'STA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/dal.png' },
  douglas_mammoth: { name:'Mammoth', leagueKey:'nhl', draftTeamId:'douglas', boardSub:'NHL', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#7AB2E1;', badgeText:'MAM', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/uta.png' },
  collin_hurricanes: { name:'Hurricanes', leagueKey:'nhl', draftTeamId:'collin', boardSub:'NHL', sub:"", accent:'#E30426', badgeStyle:'background:#E30426; color:#FFFFFF;', badgeText:'HUR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/car.png' },
  erichylok_jets: { name:'Jets', leagueKey:'nhl', draftTeamId:'erichylok', boardSub:'NHL', sub:"", accent:'#002D62', badgeStyle:'background:#002D62; color:#C41230;', badgeText:'JET', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/wpg.png' },
  patrick_oilers: { name:'Oilers', leagueKey:'nhl', draftTeamId:'patrick', boardSub:'NHL', sub:"", accent:'#00205B', badgeStyle:'background:#00205B; color:#FF4C00;', badgeText:'OIL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/edm.png' },
  peter_goldenknights: { name:'Golden Knights', leagueKey:'nhl', draftTeamId:'peter', boardSub:'NHL', sub:"", accent:'#344043', badgeStyle:'background:#344043; color:#B4975A;', badgeText:'GK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/vgk.png' },
  ericprister_panthers: { name:'Panthers', leagueKey:'nhl', draftTeamId:'ericprister', boardSub:'NHL', sub:"", accent:'#E51937', badgeStyle:'background:#E51937; color:#FFFFFF;', badgeText:'PAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/fla.png' },
  donny_capitals: { name:'Capitals', leagueKey:'nhl', draftTeamId:'donny', boardSub:'NHL', sub:"", accent:'#D71830', badgeStyle:'background:#D71830; color:#FFFFFF;', badgeText:'CAP', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/wsh.png' },
  isaac_sabres: { name:'Sabres', leagueKey:'nhl', draftTeamId:'isaac', boardSub:'NHL', sub:"", accent:'#00468B', badgeStyle:'background:#00468B; color:#FDB71A;', badgeText:'SAB', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/buf.png' },
  drew_senators: { name:'Senators', leagueKey:'nhl', draftTeamId:'drew', boardSub:'NHL', sub:"", accent:'#DD1A32', badgeStyle:'background:#DD1A32; color:#B79257;', badgeText:'SEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/ott.png' },
  douglas_predators: { name:'Predators', leagueKey:'nhl', draftTeamId:'douglas', boardSub:'NHL', sub:"", accent:'#FDBA31', badgeStyle:'background:#FDBA31; color:#002D62;', badgeText:'PRE', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/nsh.png' },
  collin_canadiens: { name:'Canadiens', leagueKey:'nhl', draftTeamId:'collin', boardSub:'NHL', sub:"", accent:'#C41230', badgeStyle:'background:#C41230; color:#FFFFFF;', badgeText:'CAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/mtl.png' },
  erichylok_kraken: { name:'Kraken', leagueKey:'nhl', draftTeamId:'erichylok', boardSub:'NHL', sub:"", accent:'#000D33', badgeStyle:'background:#000D33; color:#A3DCE4;', badgeText:'KRA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/sea.png' },
  patrick_sharks: { name:'Sharks', leagueKey:'nhl', draftTeamId:'patrick', boardSub:'NHL', sub:"", accent:'#00788A', badgeStyle:'background:#00788A; color:#FFFFFF;', badgeText:'SHA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/sj.png' },
  peter_devils: { name:'Devils', leagueKey:'nhl', draftTeamId:'peter', boardSub:'NHL', sub:"", accent:'#E30B2B', badgeStyle:'background:#E30B2B; color:#FFFFFF;', badgeText:'DEV', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/nj.png' },
  ericprister_avalanche: { name:'Avalanche', leagueKey:'nhl', draftTeamId:'ericprister', boardSub:'NHL', sub:"", accent:'#860038', badgeStyle:'background:#860038; color:#FFFFFF;', badgeText:'AVA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/col.png' },
  donny_kings: { name:'Kings', leagueKey:'nhl', draftTeamId:'donny', boardSub:'NHL', sub:"", accent:'#121212', badgeStyle:'background:#121212; color:#A2AAAD;', badgeText:'KIN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/la.png' },
  isaac_bluejackets: { name:'Blue Jackets', leagueKey:'nhl', draftTeamId:'isaac', boardSub:'NHL', sub:"", accent:'#002D62', badgeStyle:'background:#002D62; color:#E31937;', badgeText:'BJ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/cbj.png' },
  drew_islanders: { name:'Islanders', leagueKey:'nhl', draftTeamId:'drew', boardSub:'NHL', sub:"", accent:'#00529B', badgeStyle:'background:#00529B; color:#F47D31;', badgeText:'ISL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/nyi.png' },
  douglas_blues: { name:'Blues', leagueKey:'nhl', draftTeamId:'douglas', boardSub:'NHL', sub:"", accent:'#0070B9', badgeStyle:'background:#0070B9; color:#FDB71A;', badgeText:'BLU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/stl.png' },
  collin_mapleleafs: { name:'Maple Leafs', leagueKey:'nhl', draftTeamId:'collin', boardSub:'NHL', sub:"", accent:'#003E7E', badgeStyle:'background:#003E7E; color:#FFFFFF;', badgeText:'ML', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/tor.png' },
  erichylok_canucks: { name:'Canucks', leagueKey:'nhl', draftTeamId:'erichylok', boardSub:'NHL', sub:"", accent:'#003E7E', badgeStyle:'background:#003E7E; color:#008752;', badgeText:'CAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/van.png' },
  patrick_rangers: { name:'Rangers', leagueKey:'nhl', draftTeamId:'patrick', boardSub:'NHL', sub:"", accent:'#0056AE', badgeStyle:'background:#0056AE; color:#E51937;', badgeText:'RAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/nyr.png' },
  peter_bruins: { name:'Bruins', leagueKey:'nhl', draftTeamId:'peter', boardSub:'NHL', sub:"", accent:'#231F20', badgeStyle:'background:#231F20; color:#FDB71A;', badgeText:'BRU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/bos.png' },
  ericprister_wild: { name:'Wild', leagueKey:'nhl', draftTeamId:'ericprister', boardSub:'NHL', sub:"", accent:'#124734', badgeStyle:'background:#124734; color:#FFFFFF;', badgeText:'WIL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/min.png' },
  donny_penguins: { name:'Penguins', leagueKey:'nhl', draftTeamId:'donny', boardSub:'NHL', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#FDB71A;', badgeText:'PEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/pit.png' },
  isaac_yankees: { name:'Yankees', leagueKey:'mlb', draftTeamId:'isaac', boardSub:'MLB', sub:"", accent:'#132448', badgeStyle:'background:#132448; color:#C4CED4;', badgeText:'YAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/nyy.png' },
  drew_brewers: { name:'Brewers', leagueKey:'mlb', draftTeamId:'drew', boardSub:'MLB', sub:"", accent:'#13294B', badgeStyle:'background:#13294B; color:#FFC72C;', badgeText:'BRE', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/mil.png' },
  douglas_bluejays: { name:'Blue Jays', leagueKey:'mlb', draftTeamId:'douglas', boardSub:'MLB', sub:"", accent:'#134A8E', badgeStyle:'background:#134A8E; color:#FFFFFF;', badgeText:'BJ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/tor.png' },
  collin_dodgers: { name:'Dodgers', leagueKey:'mlb', draftTeamId:'collin', boardSub:'MLB', sub:"", accent:'#005A9C', badgeStyle:'background:#005A9C; color:#FFFFFF;', badgeText:'DOD', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/lad.png' },
  erichylok_braves: { name:'Braves', leagueKey:'mlb', draftTeamId:'erichylok', boardSub:'MLB', sub:"", accent:'#0C2340', badgeStyle:'background:#0C2340; color:#BA0C2F;', badgeText:'BRA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/atl.png' },
  patrick_twins: { name:'Twins', leagueKey:'mlb', draftTeamId:'patrick', boardSub:'MLB', sub:"", accent:'#031F40', badgeStyle:'background:#031F40; color:#E20E32;', badgeText:'TWI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/min.png' },
  peter_orioles: { name:'Orioles', leagueKey:'mlb', draftTeamId:'peter', boardSub:'MLB', sub:"", accent:'#DF4601', badgeStyle:'background:#DF4601; color:#000000;', badgeText:'ORI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/bal.png' },
  ericprister_rays: { name:'Rays', leagueKey:'mlb', draftTeamId:'ericprister', boardSub:'MLB', sub:"", accent:'#092C5C', badgeStyle:'background:#092C5C; color:#8FBCE6;', badgeText:'RAY', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/tb.png' },
  donny_tigers: { name:'Tigers', leagueKey:'mlb', draftTeamId:'donny', boardSub:'MLB', sub:"", accent:'#0A2240', badgeStyle:'background:#0A2240; color:#FF4713;', badgeText:'TIG', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/det.png' },
  isaac_guardians: { name:'Guardians', leagueKey:'mlb', draftTeamId:'isaac', boardSub:'MLB', sub:"", accent:'#002B5C', badgeStyle:'background:#002B5C; color:#E31937;', badgeText:'GUA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/cle.png' },
  drew_whitesox: { name:'White Sox', leagueKey:'mlb', draftTeamId:'drew', boardSub:'MLB', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#C4CED4;', badgeText:'WS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/chw.png' },
  douglas_marlins: { name:'Marlins', leagueKey:'mlb', draftTeamId:'douglas', boardSub:'MLB', sub:"", accent:'#00A3E0', badgeStyle:'background:#00A3E0; color:#000000;', badgeText:'MAR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/mia.png' },
  collin_redsox: { name:'Red Sox', leagueKey:'mlb', draftTeamId:'collin', boardSub:'MLB', sub:"", accent:'#0D2B56', badgeStyle:'background:#0D2B56; color:#BD3039;', badgeText:'RS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/bos.png' },
  erichylok_astros: { name:'Astros', leagueKey:'mlb', draftTeamId:'erichylok', boardSub:'MLB', sub:"", accent:'#002D62', badgeStyle:'background:#002D62; color:#EB6E1F;', badgeText:'AST', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/hou.png' },
  patrick_athletics: { name:'Athletics', leagueKey:'mlb', draftTeamId:'patrick', boardSub:'MLB', sub:"", accent:'#003831', badgeStyle:'background:#003831; color:#EFB21E;', badgeText:'ATH', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/ath.png' },
  peter_royals: { name:'Royals', leagueKey:'mlb', draftTeamId:'peter', boardSub:'MLB', sub:"", accent:'#004687', badgeStyle:'background:#004687; color:#FFFFFF;', badgeText:'ROY', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/kc.png' },
  ericprister_diamondbacks: { name:'Diamondbacks', leagueKey:'mlb', draftTeamId:'ericprister', boardSub:'MLB', sub:"", accent:'#AA182C', badgeStyle:'background:#AA182C; color:#FFFFFF;', badgeText:'DIA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/ari.png' },
  donny_mariners: { name:'Mariners', leagueKey:'mlb', draftTeamId:'donny', boardSub:'MLB', sub:"", accent:'#005C5C', badgeStyle:'background:#005C5C; color:#FFFFFF;', badgeText:'MAR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/sea.png' },
  isaac_mets: { name:'Mets', leagueKey:'mlb', draftTeamId:'isaac', boardSub:'MLB', sub:"", accent:'#002D72', badgeStyle:'background:#002D72; color:#FF5910;', badgeText:'MET', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/nym.png' },
  drew_rockies: { name:'Rockies', leagueKey:'mlb', draftTeamId:'drew', boardSub:'MLB', sub:"", accent:'#33006F', badgeStyle:'background:#33006F; color:#FFFFFF;', badgeText:'ROC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/col.png' },
  douglas_pirates: { name:'Pirates', leagueKey:'mlb', draftTeamId:'douglas', boardSub:'MLB', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#FDB827;', badgeText:'PIR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/pit.png' },
  collin_phillies: { name:'Phillies', leagueKey:'mlb', draftTeamId:'collin', boardSub:'MLB', sub:"", accent:'#E81828', badgeStyle:'background:#E81828; color:#FFFFFF;', badgeText:'PHI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/phi.png' },
  erichylok_rangers: { name:'Rangers', leagueKey:'mlb', draftTeamId:'erichylok', boardSub:'MLB', sub:"", accent:'#003278', badgeStyle:'background:#003278; color:#C0111F;', badgeText:'RAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/tex.png' },
  patrick_reds: { name:'Reds', leagueKey:'mlb', draftTeamId:'patrick', boardSub:'MLB', sub:"", accent:'#C6011F', badgeStyle:'background:#C6011F; color:#FFFFFF;', badgeText:'RED', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/cin.png' },
  peter_angels: { name:'Angels', leagueKey:'mlb', draftTeamId:'peter', boardSub:'MLB', sub:"", accent:'#BA0021', badgeStyle:'background:#BA0021; color:#C4CED4;', badgeText:'ANG', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/laa.png' },
  ericprister_cardinals: { name:'Cardinals', leagueKey:'mlb', draftTeamId:'ericprister', boardSub:'MLB', sub:"", accent:'#BE0A14', badgeStyle:'background:#BE0A14; color:#FFFFFF;', badgeText:'CAR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/stl.png' },
  donny_giants: { name:'Giants', leagueKey:'mlb', draftTeamId:'donny', boardSub:'MLB', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#FD5A1E;', badgeText:'GIA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/sf.png' },
  isaac_mercury: { name:'Mercury', leagueKey:'wnba', draftTeamId:'isaac', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'MER', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/phx.png' },
  drew_sky: { name:'Sky', leagueKey:'wnba', draftTeamId:'drew', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'SKY', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/chi.png' },
  douglas_lynx: { name:'Lynx', leagueKey:'wnba', draftTeamId:'douglas', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'LYN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/min.png' },
  collin_dream: { name:'Dream', leagueKey:'wnba', draftTeamId:'collin', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'DRE', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/atl.png' },
  erichylok_liberty: { name:'Liberty', leagueKey:'wnba', draftTeamId:'erichylok', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'LIB', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/ny.png' },
  patrick_wings: { name:'Wings', leagueKey:'wnba', draftTeamId:'patrick', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'WIN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/dal.png' },
  peter_aces: { name:'Aces', leagueKey:'wnba', draftTeamId:'peter', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'ACE', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/lv.png' },
  ericprister_mystics: { name:'Mystics', leagueKey:'wnba', draftTeamId:'ericprister', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'MYS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/wsh.png' },
  donny_fever: { name:'Fever', leagueKey:'wnba', draftTeamId:'donny', boardSub:'WNBA', sub:"", accent:'#FF6900', badgeStyle:'background:#FF6900; color:#FFFFFF;', badgeText:'FEV', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/wnba/500/ind.png' },
  ...
  isaac_uconn: { name:'UConn', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'College BB', sub:"", accent:'#0C2340', badgeStyle:'background:#0C2340; color:#A2AAAD;', badgeText:'UCO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/41.png' },
  drew_michigan: { name:'Michigan', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'College BB', sub:"", accent:'#00274C', badgeStyle:'background:#00274C; color:#FFCB05;', badgeText:'MIC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/130.png' },
  douglas_duke: { name:'Duke', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'College BB', sub:"", accent:'#00539B', badgeStyle:'background:#00539B; color:#FFFFFF;', badgeText:'DUK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/150.png' },
  collin_arizona: { name:'Arizona', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'College BB', sub:"", accent:'#CC0033', badgeStyle:'background:#CC0033; color:#FFFFFF;', badgeText:'ARI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/12.png' },
  erichylok_kansas: { name:'Kansas', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'College BB', sub:"", accent:'#0051BA', badgeStyle:'background:#0051BA; color:#E8000D;', badgeText:'KAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2305.png' },
  patrick_illinois: { name:'Illinois', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'College BB', sub:"", accent:'#FF5F05', badgeStyle:'background:#FF5F05; color:#13294B;', badgeText:'ILL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/356.png' },
  peter_michstate: { name:'Mich State', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'College BB', sub:"", accent:'#173F35', badgeStyle:'background:#173F35; color:#FFFFFF;', badgeText:'MS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/127.png' },
  ericprister_iowastate: { name:'Iowa State', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'College BB', sub:"", accent:'#AE192D', badgeStyle:'background:#AE192D; color:#FFC72A;', badgeText:'IS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/66.png' },
  donny_florida: { name:'Florida', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'College BB', sub:"", accent:'#0021A5', badgeStyle:'background:#0021A5; color:#FA4616;', badgeText:'FLO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/57.png' },
  isaac_tennessee: { name:'Tennessee', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'College BB', sub:"", accent:'#FF8200', badgeStyle:'background:#FF8200; color:#FFFFFF;', badgeText:'TEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2633.png' },
  drew_alabama: { name:'Alabama', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'College BB', sub:"", accent:'#9E1B32', badgeStyle:'background:#9E1B32; color:#FFFFFF;', badgeText:'ALA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/333.png' },
  douglas_texas: { name:'Texas', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'College BB', sub:"", accent:'#AF5C37', badgeStyle:'background:#AF5C37; color:#FFFFFF;', badgeText:'TEX', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/251.png' },
  collin_stjohns: { name:'St Johns', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'College BB', sub:"", accent:'#D10000', badgeStyle:'background:#D10000; color:#FFFFFF;', badgeText:'SJ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2599.png' },
  erichylok_virginia: { name:'Virginia', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'College BB', sub:"", accent:'#232D4B', badgeStyle:'background:#232D4B; color:#F84C1E;', badgeText:'VIR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/258.png' },
  patrick_kentucky: { name:'Kentucky', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'College BB', sub:"", accent:'#0033A0', badgeStyle:'background:#0033A0; color:#FFFFFF;', badgeText:'KEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/96.png' },
  peter_arkansas: { name:'Arkansas', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'College BB', sub:"", accent:'#A32136', badgeStyle:'background:#A32136; color:#FFFFFF;', badgeText:'ARK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/8.png' },
  ericprister_vanderbilt: { name:'Vanderbilt', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'College BB', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#CFAE70;', badgeText:'VAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/238.png' },
  donny_saintmarys: { name:'Saint Mary\'s', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'College BB', sub:"", accent:'#D80024', badgeStyle:'background:#D80024; color:#FFFFFF;', badgeText:'SMS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2608.png' },
  isaac_miami: { name:'Miami', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'College BB', sub:"", accent:'#F47423', badgeStyle:'background:#F47423; color:#035131;', badgeText:'MIA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2390.png' },
  drew_gonzaga: { name:'Gonzaga', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'College BB', sub:"", accent:'#041E42', badgeStyle:'background:#041E42; color:#C8102E;', badgeText:'GON', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2250.png' },
  douglas_texastech: { name:'Texas Tech', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'College BB', sub:"", accent:'#000000', badgeStyle:'background:#000000; color:#DA291C;', badgeText:'TT', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2641.png' },
  collin_northcarolina: { name:'North Carolina', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'College BB', sub:"", accent:'#7BAFD4', badgeStyle:'background:#7BAFD4; color:#13294B;', badgeText:'NC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/153.png' },
  erichylok_nebraska: { name:'Nebraska', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'College BB', sub:"", accent:'#E31937', badgeStyle:'background:#E31937; color:#FFFFFF;', badgeText:'NEB', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/158.png' },
  patrick_ndsu: { name:'NDSU', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'College BB', sub:"", accent:'#01402A', badgeStyle:'background:#01402A; color:#FFFFFF;', badgeText:'NDS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2449.png' },
  peter_slu: { name:'SLU', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'College BB', sub:"", accent:'#00539C', badgeStyle:'background:#00539C; color:#EBEBEB;', badgeText:'SLU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/139.png' },
  ericprister_georgia: { name:'Georgia', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'College BB', sub:"", accent:'#BA0C2F', badgeStyle:'background:#BA0C2F; color:#FFFFFF;', badgeText:'GEO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/61.png' },
  donny_louisville_cbb: { name:'Louisville', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'College BB', sub:"", accent:'#C9001F', badgeStyle:'background:#C9001F; color:#FFFFFF;', badgeText:'LOU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/97.png' }
};
