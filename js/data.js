...
export const TEAM_META = {
  ...
  donny_capitals: { name:'Capitals', leagueKey:'nhl', draftTeamId:'donny', boardSub:'Washington', sub:"Washington", accent:'#D71830', badgeStyle:'background:#D71830; color:#FFFFFF;', badgeText:'CAP', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/nhl/500/wsh.png' },
  ...
  isaac_yankees: { name:'Yankees', leagueKey:'mlb', draftTeamId:'isaac', boardSub:'New York', sub:"New York", accent:'#132448', badgeStyle:'background:#132448; color:#C4CED4;', badgeText:'YAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/mlb/500/nyy.png' },
  ...
  isaac_uconn: { name:'UConn', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'Huskies', sub:"Huskies", accent:'#0C2340', badgeStyle:'background:#0C2340; color:#A2AAAD;', badgeText:'UCO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/41.png' },
  drew_michigan: { name:'Michigan', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'Wolverines', sub:"Wolverines", accent:'#00274C', badgeStyle:'background:#00274C; color:#FFCB05;', badgeText:'MIC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/130.png' },
  douglas_duke: { name:'Duke', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'Blue Devils', sub:"Blue Devils", accent:'#00539B', badgeStyle:'background:#00539B; color:#FFFFFF;', badgeText:'DUK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/150.png' },
  collin_arizona: { name:'Arizona', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'Wildcats', sub:"Wildcats", accent:'#CC0033', badgeStyle:'background:#CC0033; color:#FFFFFF;', badgeText:'ARI', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/12.png' },
  erichylok_kansas: { name:'Kansas', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'Jayhawks', sub:"Jayhawks", accent:'#0051BA', badgeStyle:'background:#0051BA; color:#E8000D;', badgeText:'KAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2305.png' },
  patrick_illinois: { name:'Illinois', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'Fighting Illini', sub:"Fighting Illini", accent:'#FF5F05', badgeStyle:'background:#FF5F05; color:#13294B;', badgeText:'ILL', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/356.png' },
  peter_michstate: { name:'Mich State', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'Spartans', sub:"Spartans", accent:'#173F35', badgeStyle:'background:#173F35; color:#FFFFFF;', badgeText:'MS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/127.png' },
  ericprister_iowastate: { name:'Iowa State', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'Cyclones', sub:"Cyclones", accent:'#AE192D', badgeStyle:'background:#AE192D; color:#FFC72A;', badgeText:'IS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/66.png' },
  donny_florida: { name:'Florida', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'Gators', sub:"Gators", accent:'#0021A5', badgeStyle:'background:#0021A5; color:#FA4616;', badgeText:'FLO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/57.png' },
  isaac_tennessee: { name:'Tennessee', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'Volunteers', sub:"Volunteers", accent:'#FF8200', badgeStyle:'background:#FF8200; color:#FFFFFF;', badgeText:'TEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2633.png' },
  drew_alabama: { name:'Alabama', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'Crimson Tide', sub:"Crimson Tide", accent:'#9E1B32', badgeStyle:'background:#9E1B32; color:#FFFFFF;', badgeText:'ALA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/333.png' },
  douglas_texas: { name:'Texas', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'Longhorns', sub:"Longhorns", accent:'#AF5C37', badgeStyle:'background:#AF5C37; color:#FFFFFF;', badgeText:'TEX', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/251.png' },
  collin_stjohns: { name:'St Johns', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'Red Storm', sub:"Red Storm", accent:'#D10000', badgeStyle:'background:#D10000; color:#FFFFFF;', badgeText:'SJ', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2599.png' },
  erichylok_virginia: { name:'Virginia', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'Cavaliers', sub:"Cavaliers", accent:'#232D4B', badgeStyle:'background:#232D4B; color:#F84C1E;', badgeText:'VIR', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/258.png' },
  patrick_kentucky: { name:'Kentucky', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'Wildcats', sub:"Wildcats", accent:'#0033A0', badgeStyle:'background:#0033A0; color:#FFFFFF;', badgeText:'KEN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/96.png' },
  peter_arkansas: { name:'Arkansas', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'Razorbacks', sub:"Razorbacks", accent:'#A32136', badgeStyle:'background:#A32136; color:#FFFFFF;', badgeText:'ARK', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/8.png' },
  ericprister_vanderbilt: { name:'Vanderbilt', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'Commodores', sub:"Commodores", accent:'#000000', badgeStyle:'background:#000000; color:#CFAE70;', badgeText:'VAN', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/238.png' },
  donny_saintmarys: { name:'Saint Mary\'s', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'Gaels', sub:"Gaels", accent:'#D80024', badgeStyle:'background:#D80024; color:#FFFFFF;', badgeText:'SMS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2608.png' },
  isaac_miami: { name:'Miami', leagueKey:'mcbb', draftTeamId:'isaac', boardSub:'Hurricanes', sub:"Hurricanes", accent:'#F47423', badgeStyle:'background:#F47423; color:#035131;', badgeText:'MIA', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2390.png' },
  drew_gonzaga: { name:'Gonzaga', leagueKey:'mcbb', draftTeamId:'drew', boardSub:'Bulldogs', sub:"Bulldogs", accent:'#041E42', badgeStyle:'background:#041E42; color:#C8102E;', badgeText:'GON', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2250.png' },
  douglas_texastech: { name:'Texas Tech', leagueKey:'mcbb', draftTeamId:'douglas', boardSub:'Red Raiders', sub:"Red Raiders", accent:'#000000', badgeStyle:'background:#000000; color:#DA291C;', badgeText:'TT', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2641.png' },
  collin_northcarolina: { name:'North Carolina', leagueKey:'mcbb', draftTeamId:'collin', boardSub:'Tar Heels', sub:"Tar Heels", accent:'#7BAFD4', badgeStyle:'background:#7BAFD4; color:#13294B;', badgeText:'NC', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/153.png' },
  erichylok_nebraska: { name:'Nebraska', leagueKey:'mcbb', draftTeamId:'erichylok', boardSub:'Cornhuskers', sub:"Cornhuskers", accent:'#E31937', badgeStyle:'background:#E31937; color:#FFFFFF;', badgeText:'NEB', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/158.png' },
  patrick_ndsu: { name:'NDSU', leagueKey:'mcbb', draftTeamId:'patrick', boardSub:'Bison', sub:"Bison", accent:'#01402A', badgeStyle:'background:#01402A; color:#FFFFFF;', badgeText:'NDS', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/2449.png' },
  peter_slu: { name:'SLU', leagueKey:'mcbb', draftTeamId:'peter', boardSub:'Billikens', sub:"Billikens", accent:'#00539C', badgeStyle:'background:#00539C; color:#EBEBEB;', badgeText:'SLU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/139.png' },
  ericprister_georgia: { name:'Georgia', leagueKey:'mcbb', draftTeamId:'ericprister', boardSub:'Bulldogs', sub:"Bulldogs", accent:'#BA0C2F', badgeStyle:'background:#BA0C2F; color:#FFFFFF;', badgeText:'GEO', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/61.png' },
  donny_louisville_cbb: { name:'Louisville', leagueKey:'mcbb', draftTeamId:'donny', boardSub:'Cardinals', sub:"Cardinals", accent:'#C9001F', badgeStyle:'background:#C9001F; color:#FFFFFF;', badgeText:'LOU', sportsdbId:null, badgeUrl:'https://a.espncdn.com/i/teamlogos/ncaa/500/97.png' }
};
